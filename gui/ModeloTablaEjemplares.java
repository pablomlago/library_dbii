...
public class ModeloTablaEjemplares extends AbstractTableModel{
    ...
    public String getColumnName(int col){
        ...
        switch (col){
            ...
            case 4: nombre="Fecha Prestamo"; break;
            case 5: nombre="Fecha Vencemento"; break;
        }
        return nombre;
    }
    ...
    public Object getValueAt(int row, int col){
        ...
        switch (col){
            ...
            case 3: resultado=ejemplares.get(row).getNomeUsuario();break;
            case 4: resultado=ejemplares.get(row).getFechaPrestamo();break;
            case 5: resultado=ejemplares.get(row).getFechaVencemento();break;
        }
        return resultado;
    }
